  ...
  return (
    <>
      <Head>
        <meta
          name="description"
          content="QwextionOne We're dedicated to bringing fast, reliable, and affordable Internet access to communities and businesses in rural and unreached areas."
        />
        <meta
          name="viewport"
